...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-12-2025 a las 22:43:40
...
-- CREATE DATABASE IF NOT EXISTS `biblio_t1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
(45, 'Hermann Hesse', 'Demian', 'Papel', '1944', 'Inglaterra', '', '', '', 'demian.pdf', 'Libro', 'disponible'),
(46, 'JAJA', '', '', '', '', '', '', '', 'videoo.mp4', 'Video', 'disponible'),
(47, 'JAJA', '', '', '', '', '', '', '', 'videoo.mp4', 'Video', 'disponible');
...
INSERT INTO `prestamos` (`id_prestamo`, `id_libro`, `id_persona`, `fecha_prestamo`, `fecha_devolucion`, `estado`) VALUES
(1, 4, 150, '2025-12-11', '2025-12-18', 'activo');
...
--
ALTER TABLE `libros_d`
  MODIFY `id_libro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `prestamos`
  ADD CONSTRAINT `prestamos_ibfk_1` FOREIGN KEY (`id_libro`) REFERENCES `libros_d` (`id_libro`),
  ADD CONSTRAINT `prestamos_ibfk_2` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id`);
COMMIT;
